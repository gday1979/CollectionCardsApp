...
namespace CollectionCards.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Organizations",
                columns: new[] { "Id", "City", "Country", "Name", "PostalCode", "Street" },
                values: new object[,]
                {
                    { 1, "New York", "USA", "NBA", "10001", "San Antonio 21" },
                    { 2, "Boston", "USA", "NFL", "30001", "Marge 3" },
                    { 3, "Los Angeles", "USA", "MLB", "20001", "Palm 5" },
                    { 4, "Chicago", "USA", "NHL", "40001", "Pine 7" }
                });
